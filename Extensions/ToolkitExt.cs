...
namespace UnityEngine.Toolbox
{
    public static partial class ToolkitExt
    {
        ...
        /// <summary>
        /// Устанавливает масштабирование фонового изображения для <see cref="VisualElement"/>,
        /// эмулируя устаревшее свойство <c>unityBackgroundScaleMode</c> через новые свойства
        /// <c>background-position</c>, <c>background-repeat</c> и <c>background-size</c>.
        /// </summary>
        /// <typeparam name="T">Тип элемента, наследующийся от <see cref="VisualElement"/>.</typeparam>
        /// <param name="element">Целевой <see cref="VisualElement"/>.</param>
        /// <param name="mode">
        /// Режим масштабирования фонового изображения (<see cref="ScaleMode.StretchToFill"/>,
        /// <see cref="ScaleMode.ScaleAndCrop"/>, <see cref="ScaleMode.ScaleToFit"/> и т.д.).
        /// </param>
        public static void SetBackgroundScaleMode<T>(this T element, ScaleMode mode)
